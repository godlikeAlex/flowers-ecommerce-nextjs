...
} from "../../model/subscribe-schema";

import styles from "./SubscribeForm.module.css";
import useSubscribeForm from "../../api/useSubscribeForm";
...
export default function SubscribeForm() {
  ...
  const subscribeFormMutation = useSubscribeForm();

  const onSubmit = async (formValues: SubscribeFormValues) => {
    try {
      const response = await subscribeFormMutation.mutateAsync(formValues);
      ...
      toast.success(
        "Thank you! We'll let you know as soon as the store opens 💌",
