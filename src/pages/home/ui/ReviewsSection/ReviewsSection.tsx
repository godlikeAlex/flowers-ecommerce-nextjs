                ...
                <div className={styles["testimonial-card"]}>
                  <div className={styles["img-block"]}>
                    <Image
                      width={240}
                      height={240}
                      src="/images/testimonials/t-1.png"
                      alt=""
                    />
                  ...
                  <div className={styles["text-block"]}>
                    ...
                    <p>
                      “Lorem ipsum dolor sit amet consectetur. Volutpat egestas
                      non posuere faucibus. Diam consequat eros convallis enim
                      consequat arcu vitae. Est porta netus sit tellus non eget
                      purus.”
                    </p>
                  </div>
                </div>
